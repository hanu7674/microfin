    ...
    <div style={{ background: bgMain, padding: '56px 0 32px 0' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 16px' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center' }}>
          <PricingCard title="Starter" price="299" features={["Up to 100 clients", "Basic reporting", "Email support"]} buttonText="Get Started" cardBg={cardBg} cardText={cardText} borderColor={borderColor} shadow={shadow} />
          <PricingCard title="Professional" price="999" features={["Up to 1,000 clients", "Advanced analytics", "Priority support", "Mobile app access"]} buttonText="Get Started" highlight cardBg={cardBg} cardText={cardText} borderColor={borderColor} shadow={shadow} />
          <PricingCard title="Enterprise" price="***" features={["Unlimited clients", "Custom integrations", "Dedicated support", "White-label options"]} buttonText="Contact Sales" cardBg={cardBg} cardText={cardText} borderColor={borderColor} shadow={shadow} />
        </div>
      </div>
    </div>
  );
