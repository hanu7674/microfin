...
const firebaseConfig = {
  apiKey: "AIzaSyBvVQqQqQqQqQqQqQqQqQqQqQqQqQqQqQ",
  authDomain: "microfin-12345.firebaseapp.com",
  projectId: "microfin-12345",
  storageBucket: "microfin-12345.appspot.com",
...
async function addSampleInvoices() {
  try {
    console.log('Starting to add sample invoices...');
    
    // Replace with actual user ID from your Firebase Auth
    const userId = 'your-user-id-here'; // You'll need to replace this with actual user ID
    ...
    for (let i = 0; i < sampleInvoices.length; i++) {
      ...
      // Add to Firestore
      const docRef = await addDoc(collection(db, `users/${userId}/invoices`), invoiceData);
