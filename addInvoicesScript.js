...
async function addSampleInvoices() {
  try {
    ...
    const { userInvoicesRef } = await import('./src/Firebase/firebase');
...
console.log('📝 Sample invoice script loaded!');
console.log('💡 Run addSampleInvoices() in the console to add 5 sample invoices.'); 